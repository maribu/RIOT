 ...
 * @{
 */
#define LED0_PIN_NUM        5           /**< GPIO pin number of LED 0 */
#define LED0_PORT           GPIO_PORT_A /**< GPIO port of LED 0 */
#define LED0_PORT_NUM       PORT_A      /**< GPIO port number of LED 0 */

#define LED1_PIN_NUM        1           /**< GPIO pin number of LED 1 */
#define LED1_PORT           GPIO_PORT_A /**< GPIO port of LED 1 */
#define LED1_PORT_NUM       PORT_A      /**< GPIO port number of LED 1 */
/** @} */
